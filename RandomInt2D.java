...
public class RandomInt2D {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            System.out.println("count" + i + " la: " + meanArray(count[i]));
        }
        // System.out.println("count0 la: " + meanArray(count[0]));
        // System.out.println("count1 la: " + meanArray(count[1]));
        // System.out.println("count2 la: " + meanArray(count[2]));
    }
